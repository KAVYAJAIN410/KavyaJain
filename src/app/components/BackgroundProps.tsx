...
export default function BackgroundProps() {
  return (
    <>
      <div className=" w-40 h-40 md:w-80 md:h-80 rounded-full bg-secondary absolute -top-10 -left-10 md:blur-[200px] blur-[100px] pointer-events-none"></div>
      <div className=" w-40 h-40 md:w-80 md:h-80 rounded-full bg-secondary absolute bottom-0 right-0 md:blur-[200px] blur-[100px] pointer-events-none"></div>
