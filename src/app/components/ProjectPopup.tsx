...
const ProjectPopup: React.FC<ProjectProps> = ({
  ...
  return (
        ...
        <div className="Header-wrapper w-[100%] h-[50vh] mt-8">
          <div className="head-content w-full flex flex-col lg:flex-row justify-between gap-4">
            ...
            <div className="description w-[100%]  lg:w-[50%]">
              ...
              <span className="text-primary text-lg md:text-2xl font-montserrat mt-6 ">
                Github Link: 
              </span>
              <span className="ml-4"><a href={openData?.gitlink}>Click Me</a></span>
              <br></br>
              {openData?.demolink && (
             <div>
    <span className="text-primary text-lg md:text-2xl font-montserrat mt-6">
    ...
    <span className="ml-4">
      <a href={openData.demolink} target="_blank" rel="noopener noreferrer">
        Click Me
      </a>
    </span>
  </div>
