const ProjectData = [
  {
    ...
    bannerImg: "Credit.png",
    description:
      `Built an end-to-end risk intelligence system that analyzes transactional behavior, social networks, and movement patterns to predict loan default risk, detect hidden (ghost) defaulters, and generate explainable credit decisions using ensemble learning and graph-based models.`,
    imgBanners: [
      "a.jpg",
      "b.jpg",
      "c.jpg",
    ...
    tech: [ "Scikit-learn", "NetworkX" , "FastAPI", "PostgreSQL", "NumPy", "Pandas", "React", "Ensemble Learning"],
    gitlink: "google.com/url?q=https://github.com/KAVYAJAIN410/Repaymet_Assesment",
    demolink: "https://drive.google.com/file/d/1hTqPy54qWG7SO3CXw0DQrle55ovGkmMo/view?usp=sharing",
  },
    ...
    tech: ["Python", "PostgreSQL" , "Langraph", "Vector Embeddings" , "RAG", "FastAPI"],
    gitlink: "https://github.com/KAVYAJAIN410/FinanceAdvisor",
    demolink: "https://finsight-sigma.vercel.app/",
  },
   {
    id: 7,
    title: "Tool Based RAG Agent",
    bannerImg: "RAG.png",
    description:
      `Built a tool-augmented RAG pipeline using self-hosted n8n that combines document retrieval via vector embeddings with dynamic database querying through tools, enabling context-aware and real-time AI responses beyond static document knowledge.`,
    imgBanners: [
      "a.jpg",
      "b.jpg",
      "c.jpg",
    ...
    tech: ["n8n","oracle DB","postgreSQL","supabase","openRouter"],
    gitlink: "",
    demolink: "",
  },
    {
    id: 9,
    title: "Automata",
    bannerImg: "automata.png",
    description:
      `Built Automata, a workflow automation backend where external webhooks trigger multi-step actions processed with transactional reliability, enabling adaptive and asynchronous execution through distributed workers and optional AI-based decision-making to support dynamic workflows beyond static rule-based automation.`,
    imgBanners: [
      "a.jpg",
      "b.jpg",
      "c.jpg",
    ...
    tech: ["Java", "Spring Boot", "PostgreSQL", "JPA/Hibernate", "Kafka", "Microservices", "Spring Cloud", "Docker", "MCP", "LLM Integration"],
    gitlink: "https://github.com/KAVYAJAIN410/Automata",
    demolink: "",
  },
...
protection`,
    ...
    gitlink: "https://github.com/KAVYAJAIN410/circleOfCare/tree/main/my-app",
    demolink: "https://circle-of-care-2.vercel.app/",
  },
  {
    id: 4,
    title: "VR-ALIGN",
...
protection.`,
    ...
    gitlink: "",
    demolink: "https://github.com/KAVYAJAIN410/ACEi",
  },
  {
    id: 5,
    title: "Peer to Peer",
  ...
  },
  {
    ...
    gitlink: "https://github.com/KAVYAJAIN410/Vortex",
    demolink: "https://vortex-weld.vercel.app/",
  },
